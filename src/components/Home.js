      ...
      <div className="row">
        <div className="span8">
          <p>
            ...
            develop my own recipes to share with family and friends inspired by
            food science, seasonality, and flavors. Sometimes I hold giveaways
            and seasonal sales. In the past I have catered pie for{" "}
